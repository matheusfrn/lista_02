...
<s> C) O código verifica se o número é par, ímpar ou divisível por 3. Se for par, exibe a mensagem "O número é par!". Se for divisível por 3, exibe a mensagem "O número é divisível por 3!". Se for ímpar, exibe a mensagem "O número é ímpar e não é divisível por 3!". </s>
...
se (idade menor que 16) {imprima('não pode votar')}

se (idade maior que 16 e menor 18) {imprima('o voto é facultativo')}

se (idade maior que 18 e menor 70) {imprima('o voto é obrigatório')}

se (idade maior que 70) {imprima('o voto é facultativo')}
...
```
    Classe FormaGeometrica:
        ...
        Método CalcularArea():
        se (número de lados === 4){
        base*largura           
        }
           
        se (número de lados === 0){
            3,14*(raio^2)
        }
